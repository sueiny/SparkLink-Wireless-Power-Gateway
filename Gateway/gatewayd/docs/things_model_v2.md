...
- **命名规范**：DTU节点命名为 `DTU_XXX`（如DTU_001, DTU_036），设备命名为 `METER_XXX`、`ENV_XXX`、`RELAY_XXX`
...
- **节点1（Root）**：`DTU_001`
- **一级节点**：`DTU_036`, `DTU_037`, `DTU_041`, `DTU_044`, `DTU_064`
- **二级节点**：`DTU_039`, `DTU_042`, `DTU_063`, ...
- **三级节点**：`DTU_038`, `DTU_048`, `DTU_043`, ...
- **四级节点**：`DTU_032`, `DTU_047`, `DTU_054`, ...
...
struct DtuNodeInfo {
    ...
    std::string name;               // 设备名称，如 "DTU_036"
