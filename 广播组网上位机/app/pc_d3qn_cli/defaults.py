...
class D3QNDefaults:
    gateway: int = 0x00
    nodes: tuple[int, ...] = (0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A)
    ...
    first_work_train_episode: int = 60
...
def default_simulation_params(defaults: D3QNDefaults = DEFAULTS) -> dict:
    return {
