...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', help='data file', type=str, default='./DQN_pytorch/Logs/expsample_DQN_agentLogs.txt', nargs='+')
    ...
    if not os.path.exists("./DQN_pytorch/Images"):
        os.makedirs("./DQN_pytorch/Images")
    ...
    plt.savefig("./DQN_pytorch/Images/AvgTestScore_" + differentiation_str)
    plt.close()
    ...
    plt.savefig("./DQN_pytorch/Images/Epsilon_" + differentiation_str)
    plt.close()
    ...
    plt.ylabel("Loss")
    plt.yscale("log")
    plt.savefig("./DQN_pytorch/Images/AvgLosses_" + differentiation_str)
    plt.close()