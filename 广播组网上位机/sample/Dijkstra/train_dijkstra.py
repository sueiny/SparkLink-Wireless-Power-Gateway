...
from dijkstra import DijkstraAgent, device, evaluation_interval, listofDemands
...
graph_topology = 0
SEED = int(os.environ.get("DIJKSTRA_SEED", "37"))

ITERATIONS = int(os.environ.get("DIJKSTRA_ITERATIONS", "2000"))
TRAINING_EPISODES = int(os.environ.get("DIJKSTRA_TRAINING_EPISODES", "20"))
EVALUATION_EPISODES = int(os.environ.get("DIJKSTRA_EVALUATION_EPISODES", "20"))
FIRST_WORK_TRAIN_EPISODE = int(os.environ.get("DIJKSTRA_FIRST_WORK_TRAIN_EPISODE", "60"))
...
if __name__ == "__main__":
    ...
    agent = DijkstraAgent(env_training)
